...
for (int index =0; index<data.getRowNumbers(); index++) {
	...
	readBinaries.setRestUrl('http://us-west-2.api.unimatrix.io/realms/faf10fa99bf536f7c219b7c37cf7a705/binaries?uuid.in='+internal.GlobalVariable.binaryReadId+'&access_token=1b014b8eb4dfec8cbb137b81b42205b8')
