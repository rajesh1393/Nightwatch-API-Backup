...
for (int index =0; index<qmData.getRowNumbers(); index++) {
	...
	writeBinary.setRestUrl('http://us-west-2.quartermaster.acceptance.boxxspring.net/realms/f53dbe250d8a05d1ca44b28b95eb5e20/binaries?access_token=5422e9fefd05e874dfea631770b9f7bb')
