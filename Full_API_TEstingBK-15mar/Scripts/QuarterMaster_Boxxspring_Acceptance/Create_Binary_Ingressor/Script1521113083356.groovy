...
for (int index =0; index<data.getRowNumbers(); index++) {
	...
	writeBinaryIngressor.setRestUrl('http://us-west-2.quartermaster.acceptance.boxxspring.net/realms/f53dbe250d8a05d1ca44b28b95eb5e20/binaries/'+internal.GlobalVariable.binaryId+'/binaries_ingressors?access_token=5422e9fefd05e874dfea631770b9f7bb')
...
//	 "url": "https://cdn2.hubspot.net/hubfs/208250/Blog_Images/jmeter324.png"
	...
	json.binaries_ingressors[0] << [url:url]
	println json.binaries_ingressors[0]<< [url:url]
	...
	println ("Response for Binary_Ingressor with Binary_uuid: ${requestContent.binaries_ingressors[0].binary_uuid}")
