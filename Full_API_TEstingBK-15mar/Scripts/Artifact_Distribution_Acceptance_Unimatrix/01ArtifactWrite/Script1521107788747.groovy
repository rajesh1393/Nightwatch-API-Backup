...
for (int index =0; index<data.getRowNumbers(); index++) {
	...
	writeArtifact.setRestUrl('http://us-west-2.api.acceptance.unimatrix.io/realms/1e338862026376dd593425404a4f75c0/artifacts?access_token=5422e9fefd05e874dfea631770b9f7bb')
