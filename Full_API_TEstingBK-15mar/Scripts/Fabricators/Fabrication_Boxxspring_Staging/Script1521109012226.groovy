...
for (int index = 0; index < data.getRowNumbers(); index++) {
    ...
    writeFabricator.setRestUrl('http://us-west-2.fabricator.staging.boxxspring.net/realms/' + data.internallyGetValue('Realm_uuid', 
    ...
    readFabricator.setRestUrl('http://us-west-2.fabricator.staging.boxxspring.net/realms/' + write_source_realm_uuid + 
        '/fabrications?uuid=' + write_uuid + '&access_token=88c6f9ed498a38fd13af586bd9b42f8e')
	def responseRead = WS.sendRequest(readFabricator)
	
    for (def delayTime = 0; delayTime <= 5; delayTime ++) {
    ...
    blueprintsSource.setRestUrl('http://us-west-2.archivist.staging.boxxspring.net/realms/' + read_source_realm_uuid + 
    ...
    blueprintsTarget.setRestUrl(('http://us-west-2.archivist.staging.boxxspring.net/realms/' + read_target_realm_uuid) + 
        '/blueprints?access_token=88c6f9ed498a38fd13af586bd9b42f8e&count=100')
    ...
    blueprintAttributeSource.setRestUrl(('http://us-west-2.archivist.staging.boxxspring.net/realms/' + read_source_realm_uuid) + 
    ...
    blueprintAttributeTarget.setRestUrl(('http://us-west-2.archivist.staging.boxxspring.net/realms/' + read_target_realm_uuid) + 
        '/blueprint_attributes?access_token=88c6f9ed498a38fd13af586bd9b42f8e&count=100')
