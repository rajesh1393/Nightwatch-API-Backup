...
for (int index =0; index<data.getRowNumbers(); index++) {
	...
	writeBinaryIngressor.setRestUrl('http://us-west-2.api.staging.unimatrix.io/realms/e7400579919e0823318073748cd375d7/binaries/'+internal.GlobalVariable.binaryId+'/ingressors?access_token=ae9d499be403b3e5b7e786e1458df125')
